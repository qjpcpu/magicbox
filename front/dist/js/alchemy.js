(function() {
  ...
  Layout = (function() {
    ...
    Layout.prototype.positionRootNodes = function() {
      ...
      conf = this.a.conf;
      container = {
        width: conf.graphWidth()/3,
        height: conf.graphHeight()/3
      };
